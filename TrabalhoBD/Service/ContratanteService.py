...
class ContratanteService:
    ...
    def create_contratante(self, nome, endereco, telefone):
        ...
        return 'Contratante criado com sucesso na base de dados, dados: ' + 'id: ' + str(contratante.get_id()) + \
               ', nome: ' + contratante.get_nome() + ', endereço: ' + contratante.get_endereco() + ', telefone: ' + \
               contratante.get_telefone()
